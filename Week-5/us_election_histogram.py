...
state_fractions.plot(kind='bar', title=f'Vote Fraction for {candidate} by State', edgecolor='black')
plt.xlabel('State')
...
candidate_vote_fractions.plot(kind='bar', title=f'Fraction of {candidate} Votes by State', edgecolor='black', color='orange')
plt.xlabel('State')
